...
var Client = (function () {
    function Client() {
        ...
        this.open = function (options, cb) {
            ...
            _this.connectOptions = __assign({ timeout: 10000, reuseConnectionMetadata: false }, options);
            _this.debug({
                type: 'breadcrumb',
                message: 'open',
                data: { polling: false },
        ...
        this.debug = function (log) {
            if (_this.legacyDebugFunc) {
                _this.legacyDebugFunc(log);
            }
            _this.debugFuncs.forEach(function (func) { return func(log); });
        };
        this.setDebugFunc = function (debugFunc) {
            _this.legacyDebugFunc = debugFunc;
        };
        this.addDebugFunc = function (debugFunc) {
        ...
        this.connect = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var error, error, error, chan0, abortController, connectionMetadataFetchResult, e_1, connectionMetadata, aborted, isPolling, WebSocketClass, connStr, ws, didWebsocketsWork, didReceiveAnyCommand, onFailed, resetTimeout, cancelTimeout, timeout, timeoutId_1, unlistenChan0;
                var _this = this;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 5:
                            ...
                            connStr = helpers_1.getConnectionStr(this.connectionMetadata, isPolling, this.connectOptions.pollingHost);
                            ...
                            ws.onclose = function (event) {
                                ...
                                if (WebSocketClass === EIOCompat_1.EIOCompat) {
                                    ...
                                    var closeCodePolicyViolation = 1008;
