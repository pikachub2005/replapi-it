...
test('client retries and caches tokens', function (done) {
    ...
    client.addDebugFunc(function (log) {
...
test('allows opening channel with the same name after others are closing others and client is connected', function (done) {
    ...
    client.open({
        ...
        close();
        var close2 = client.openChannel({ name: name, service: 'exec' }, function (_a) {
            ...
            var close3 = client.openChannel({ name: name, service: 'exec' }, function (_a) {
